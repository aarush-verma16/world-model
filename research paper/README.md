...
- **M6 baseline** (`configs/m6_baseline.yaml`): harness 2026-08-26. Continue M5 100k → 1M, cap 10000, official gmean. **No 1M score yet.** Live: `notebooks/09_train_baseline.ipynb`.
