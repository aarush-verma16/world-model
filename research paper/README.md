...
- **M9 streaming replay** (`configs/m9_xl.yaml`): from-scratch XL, `is_first` + live-stream buffer, new dirs `checkpoints/m9_xl`. Still ratio 32 / seq 32. `notebooks/10_train_paper_online.ipynb`.
