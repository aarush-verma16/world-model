...
- **M17 paper knobs** (`configs/m17_xl_paper.yaml`): seq **64**, GRU **4096**, replay **1e6**, paper free-nats, actor on from 0, batch **8** bf16 (finding 31). Fresh dirs. `notebooks/10_train_paper_online.ipynb`.
